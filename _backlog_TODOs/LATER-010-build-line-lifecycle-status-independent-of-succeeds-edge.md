...
- **Status:** open — design captured; needs **implementation in the GEN2 schema** (the `build_line_edges` / generations model is currently *design-only*, not yet built in the running app). John explicitly wants this implemented in the near-future.
