...
KICKER    = "Divia.AI &middot; AgentSwarms"    # small uppercase line above the cover title
TITLE     = "The Agent-Harness Landscape"      # big cover wordmark
SUBTITLE  = "Competitive Deep-Dive &mdash; the &ldquo;-Claw&rdquo; family, Hermes Agent &amp; peers"
OUT_HTML  = "/tmp/agentswarms-compendium.html"  # UNIQUE per project — avoid /tmp collisions!
COVER_META = (                                 # free HTML under the cover rule; <br> between lines
    "Synthesis &nbsp;+&nbsp; Research Plan &amp; Dispatch Manifest &nbsp;+&nbsp; 34 analyses<br>"
    "Phase 00 Research &middot; ~200k words &middot; 853 cited sources<br>"
    "Synthesis complete &middot; 2026-06-18"
)
COVER_NOTE = "The decision-grade synthesis opens the document, followed by the Research Plan &amp; Dispatch Manifest; the 34 analyses follow as deep-dives."
...
BASE = "/home/jstanforth/Code/DiviaAI/divia_ai-agentswarms/_specs_and_plans/_research/agent_harness_landscape"
APPX = BASE
