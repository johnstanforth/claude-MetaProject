...
KICKER    = "Org &middot; Division"            # small uppercase line above the cover title
TITLE     = "Project Name"                     # big cover wordmark
SUBTITLE  = "What this research is about"       # cover subtitle
OUT_HTML  = "/tmp/PROJECT-compendium.html"      # UNIQUE per project — avoid /tmp collisions!
COVER_META = (                                 # free HTML under the cover rule; <br> between lines
    "Synthesis &nbsp;+&nbsp; N analyses<br>"
    "Phase &middot; Sprint &nbsp;&middot;&nbsp; YYYY-MM-DD"
)
COVER_NOTE = "Read the synthesis first; the analyses follow as deep-dives."

# Research source dir(s). BASE should hold synthesis.md and/or analysis-*.md.
# APPX (optional) holds the appendix docs named in APPENDICES.
BASE = "/abs/path/to/<research_dir>"
APPX = "/abs/path/to/<appendix_dir>"
APPENDICES = [                                 # (toc_label, sec_label, filename-in-APPX) — optional
    # ("Appendix A &middot; Spec", "Appendix A", "SPEC.md"),
]
...
if os.path.exists(syn):
    sections.append(("synthesis", "Synthesis — Combined Recommendation", "Synthesis", conv(syn)))
